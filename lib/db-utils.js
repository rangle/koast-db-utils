...
var config = undefined; // this gets passed in
var log = undefined; // this gets passed in
 ...
 */
exports.createSingleConnection = function (handle, dbConfig, schemas, configIn) {
  config = configIn;
 ...
 *                                 ready connections.
 */
exports.createConfiguredConnections = function (subset, callback, configIn, logIn) {
  config = configIn;
  log = logIn;
